...
fun SkillIcon(
    ...
    Box(
        ...
        Text(
            text = AppIcon.fromNameCode("skill_${skillCode}_inverted").glyph,
        ...
        Text(
            text = AppIcon.fromNameCode("skill_$skillCode").glyph,
            fontFamily = AppIconsFont,
            fontSize = iconSize,
...
fun HealthSanityNumericIcon(
    ...
    Row(
        ...
        Box(contentAlignment = Alignment.Center) {
            Text(
                text = AppIcon.fromNameCode("$firstNumberIcon-fill").glyph,
                fontFamily = AppIconsFont,
                fontSize = iconSize,
                color = Color.White
            )
            Text(
                text = AppIcon.fromNameCode("$firstNumberIcon-outline").glyph,
                fontFamily = AppIconsFont,
                fontSize = iconSize,
                color = color
            )
        ...
        secondNumberIcon?.let {
            Box(contentAlignment = Alignment.Center) {
                Text(
                    text = AppIcon.fromNameCode("$it-fill").glyph,
                    fontFamily = AppIconsFont,
                    fontSize = iconSize,
                    color = Color.White
                )
                Text(
                    text = AppIcon.fromNameCode("$it-outline").glyph,
                    fontFamily = AppIconsFont,
                    fontSize = iconSize,
                    color = color
                )
